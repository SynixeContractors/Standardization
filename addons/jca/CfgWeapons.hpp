class CfgWeapons {
    ...
    class JCA_hgun_M9A1_base_F;
    class JCA_hgun_M9A1_black_F: JCA_hgun_M9A1_base_F {
        displayName = "M9A1 (Black)";
    };
    class JCA_hgun_M9A1_olive_F: JCA_hgun_M9A1_base_F {
        displayName = "M9A1 (Olive)";
    };
    class JCA_hgun_M9A1_sand_F: JCA_hgun_M9A1_base_F {
        displayName = "M9A1 (Sand)";
    };

    class JCA_hgun_Mk23_base_F;
    class JCA_hgun_Mk23_black_F: JCA_hgun_Mk23_base_F {
        displayName = "Mk23 (Black)";
    };
    class JCA_hgun_Mk23_olive_F: JCA_hgun_Mk23_base_F {
        displayName = "Mk23 (Olive)";
    };
    class JCA_hgun_Mk23_sand_F: JCA_hgun_Mk23_base_F {
    ...
    class JCA_hgun_P226_olive_F: JCA_hgun_P226_base_F {
        displayName = "P226 (Olive)";
    };
    class JCA_hgun_P226_sand_F: JCA_hgun_P226_base_F {
    ...
    class JCA_hgun_P320_olive_F: JCA_hgun_P320_base_F {
        displayName = "P320 (Olive)";
    };
    class JCA_hgun_P320_sand_F: JCA_hgun_P320_base_F {
