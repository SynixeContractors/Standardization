class CfgWeapons {
    ...
    class arifle_XMS_khk_lxWS: arifle_XMS_Base_khk_lxWS {
        displayName = "XMS (Olive)";
    };
    ...
    class glaunch_GLX_camo_lxWS: glaunch_GLX_base_lxWS {
        displayName = "GLX 160 (DAP Green)";
    };
    class glaunch_GLX_ghex_lxWS: glaunch_GLX_base_lxWS {
        displayName = "GLX 160 (Hex Woodland)";
    };
    ...
    class LMG_S77_AAF_lxWS: LMG_S77_base_lxWS {
        displayName = "Vektor SS-77 (DAP Green)";
    };
    class LMG_S77_GHex_lxWS: LMG_S77_base_lxWS {
        displayName = "Vektor SS-77 (Hex Woodland)";
    };
